...
if(guess.equals("Arnold")) {
	...
	JOptionPane.showConfirmDialog(null, "Wrong its Arnold");
}
...
String guess1=JOptionPane.showInputDialog("Who is this?(firstname)");		
...
if(guess.equals("Leonardo")) {
	...
	JOptionPane.showConfirmDialog(null, "Wrong its Leonardo");
}
JOptionPane.showConfirmDialog(null, "Score: "+score);	
showNextImage();
